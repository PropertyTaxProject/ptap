...
CompsLookup.propTypes = {
  targRecord: PropTypes.object,
  setStep: PropTypes.func,
  selected: PropTypes.bool,
  setSelect: PropTypes.func,
  appealType: PropTypes.string,
  setComparablesPool: PropTypes.func,
  setHeaders: PropTypes.func,
  setTargetProperty: PropTypes.func,
  setPropInfo: PropTypes.func,
}
  ...
  return (
    <>
      ...
      <p>
        ...
        <b>AssessorReview@detroitmi.gov</b> no later than February 22, 2023
        (make sure to attach the evidence you downloaded from this tool!). To
        get assistance filing your appeal,{" "}
        <a href="https://actionnetwork.org/forms/property-tax-assessment-appeal-interest-form?source=app">
          {" "}
          complete our interest form
        </a>{" "}
        to sign up for FREE assistance appealing your property taxes no later
        than February 15, 2023.
      </p>
    </>
  )
}
