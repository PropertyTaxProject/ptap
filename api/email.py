...
def detroit_submission_email(mail, data):
    ...
    body = (
        "<b>A submission has been received. </b><br>"
        + "Name: "
        + name
        + "<br>"
        + "Address: "
    ...
    body = (
        ...
        + name
        + ",<br><br>"
        + "The Property Tax Appeal Project has received a submission for "
        + addr
        + ". "
        + "An advocate will reach out to you to finalize your application. If you have any questions until then, "  # noqa
        + "please contact us via phone at 313-438-8698 or via email at law-propertytax@umich.edu. <br><br> "  # noqa
        + """Steps in Appeals Process:<ul>
        <li><b>Step 1</b>: Complete this online application by <b>February 15, 2022</b>.</li>
        ...
        + "<br><br> Thank you, <br><br>The Property Tax Appeal Project Automated System<br><br>"  # noqa
...
def cook_submission_email(mail, data):
    ...
    body = (
        ...
        + ". "
        + "An advocate will reach out to you to finalize your application. If you have any questions until then, "  # noqa
        + "please contact us at chicagoptap@gmail.com. <br><br> "
        + "<br><br> Thank you, <br><br>The Property Tax Appeal Project Automated System<br><br>"  # noqa
        + "Replies to this email address are not monitored."
    )
