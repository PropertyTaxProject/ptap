...
These comparables have an average assessed value of `r dollar(mean_comps)` which is `r paste0( percent(abs(pct_diff)), " ", diff_txt, " ", params$PIN, "'s current assessed value of ", dollar(target_pin["Assessed Value"][[1]]))`.
